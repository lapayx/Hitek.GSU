...
namespace Hitek.GSU
{
    ...
    public class ApplicationUserManager : UserManager<MyAccount>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            manager.UserValidator = new UserValidator<MyAccount>(manager)
            {
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<MyAccount>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<MyAccount>
            {
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider =
                    new DataProtectorTokenProvider<MyAccount>(dataProtectionProvider.Create("ASP.NET Identity"));
            }
            return manager;
        }
    }
